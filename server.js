...
app.post('/getNearestLocations', async function (req, res) {
    ...
    var data = await rp_async(`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${stringToSearch}&key=AIzaSyBoJFhnn_8nwQltsj496SeNCN4lk03qf9w`,{method:'get'});
